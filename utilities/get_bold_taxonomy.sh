...
do
	...
	wget --retry-connrefused --waitretry=1 --read-timeout=20 --timeout=15 -t 0 --continue -O $sp "http://www.boldsystems.org/index.php/API_Public/specimen?taxon=$sp&format=tsv" > species_info.tsv
