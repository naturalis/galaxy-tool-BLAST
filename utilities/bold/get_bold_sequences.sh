...
do
	...
	echo $sp
	wget --waitretry=500 --read-timeout=200 --timeout=250 --continue -O - http://www.boldsystems.org/index.php/API_Public/sequence?taxon=$sp > "bold_fasta_files"/$sp"_sequences.fasta"
